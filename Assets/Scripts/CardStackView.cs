...
public class CardStackView : MonoBehaviour
{
    ...
    void AddCard(Vector3 position, int cardIndex, int positionalIndex)
    {
        ...
        {
            spriteRenderer.sortingOrder = 49 - positionalIndex;
        }
        else
        {
    ...
    public void DetermineCurrentCard(CardModel cardModel, int cardIndex)
    {
        ...
        int cardColorIndex = cardIndex / 12;
        int cardID = cardIndex % 12;
        ...
        */
        ...
        if (cardColorIndex == 0)
        {
            cardModel.cardColor = "red"; //oros
        }
        else if (cardColorIndex == 1)
        {
            cardModel.cardColor = "yellow"; //copas
        }
        else if (cardColorIndex == 2)
        {
            cardModel.cardColor = "green"; //espadas
        }
        else if (cardColorIndex == 3)
        {
            cardModel.cardColor = "blue"; //bastos
        }
        /*
